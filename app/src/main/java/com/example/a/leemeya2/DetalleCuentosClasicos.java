...
public class DetalleCuentosClasicos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_cuentos_clasicos);
    ...
    public void onClickt (View view){
        ...
        switch (view.getId()) {
            case R.id.txtlectura:
                miIntent = new Intent(DetalleCuentosClasicos.this, ListaMasLeidos.class);
                break;
            case R.id.button8:
                miIntent=new Intent(DetalleCuentosClasicos.this,Comentarios.class);
                break;}
