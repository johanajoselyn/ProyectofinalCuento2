...
public class AdaptadorTradicionales extends BaseAdapter {
    Context contexto;

    public AdaptadorTradicionales (Context contexto, List<Cuento> listaObjetos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        vista= inflater.inflate(R.layout.lista_tradicionales, null);
