...
public class DetalleCuentosTradicionales extends AppCompatActivity {
    ImageView foto;
    TextView titulo;
    TextView detalle;
    TextView autor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_cuentos_tradicionales);
    ...
    public void onClickt (View view){
        ...
        switch (view.getId()) {
            case R.id.txtlectura:
                miIntent = new Intent(DetalleCuentosTradicionales.this, ListaMasLeidos.class);
                break;
            case R.id.button8:
                miIntent=new Intent(DetalleCuentosTradicionales.this,Comentarios.class);
                break;}
